...
#define ENTER_LIGHT_SLEEP_LATENCY_LIMIT_US 20u
#define EXIT_LIGHT_SLEEP_LATENCY_LIMIT_US 10u
#elif CONFIG_IDF_TARGET_ESP32S2
#define ENTER_LIGHT_SLEEP_LATENCY_LIMIT_US 150u
#define EXIT_LIGHT_SLEEP_LATENCY_LIMIT_US 80u
#elif CONFIG_IDF_TARGET_ESP32S3
#define ENTER_LIGHT_SLEEP_LATENCY_LIMIT_US 80u
#define EXIT_LIGHT_SLEEP_LATENCY_LIMIT_US 60u
#else
#define ENTER_LIGHT_SLEEP_LATENCY_LIMIT_US 100u
#define EXIT_LIGHT_SLEEP_LATENCY_LIMIT_US 100u
#endif
...
static void light_sleep_enter_latency_task(void *args)
{
    ...
    for (int i = 0; i < LIGHT_SLEEP_NUM_CYCLES; i++) {
        ...
        TEST_ASSERT_INT_WITHIN_MESSAGE(ENTER_LIGHT_SLEEP_LATENCY_LIMIT_US / 2, ENTER_LIGHT_SLEEP_LATENCY_LIMIT_US, (int)enter_light_sleep_latency, "Enter light sleep latency too high");
        TEST_ASSERT_INT_WITHIN_MESSAGE(EXIT_LIGHT_SLEEP_LATENCY_LIMIT_US / 2, EXIT_LIGHT_SLEEP_LATENCY_LIMIT_US, (int)exit_light_sleep_latency, "Exit light sleep latency too high");
