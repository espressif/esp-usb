...
#define EVENT_NEW_DEV_TIMEOUT_MS    2000    // To test that device shows up on time
...
void ctrl_client_remote_wake_task(void *arg)
{
    ...
    // Handle device enumeration separately, wait for 2000ms for the device to be enumerated
    ...
    while (!exit_loop) {
        ...
        case TEST_STAGE_DEV_OPEN: {
            ESP_LOGD(REMOTE_WAKE_CLIENT_TAG, "Open");
        ...
        case TEST_STAGE_DEV_CLOSE: {
            ESP_LOGD(REMOTE_WAKE_CLIENT_TAG, "Close");
