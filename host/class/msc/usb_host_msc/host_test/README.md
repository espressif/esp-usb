...
- Unsupported READ CAPACITY(16) requirements before or after ready candidates, all LUNs exceeding the supported capacity, and the capacity boundary below the sentinel
