...
SCENARIO("Camera descriptor parsing: Logitech C270", "[logitech][c270]")
{
    ...
    GIVEN("Logitech C270 Uncompressed") {
        uvc_host_stream_format_t formats[] = {
            ...
            {752, 416, 25, UVC_VS_FORMAT_UNCOMPRESSED},
            ...
            {960, 544, 15, UVC_VS_FORMAT_UNCOMPRESSED},
            {960, 544, 10, UVC_VS_FORMAT_UNCOMPRESSED},
            {960, 544, 5, UVC_VS_FORMAT_UNCOMPRESSED},
            {960, 720, 10, UVC_VS_FORMAT_UNCOMPRESSED},
            {960, 720, 5, UVC_VS_FORMAT_UNCOMPRESSED},
            {1024, 576, 10, UVC_VS_FORMAT_UNCOMPRESSED},
            {1024, 576, 5, UVC_VS_FORMAT_UNCOMPRESSED},
            {1184, 656, 10, UVC_VS_FORMAT_UNCOMPRESSED},
            {1184, 656, 5, UVC_VS_FORMAT_UNCOMPRESSED},
            {1280, 720, 5, UVC_VS_FORMAT_UNCOMPRESSED},
            {1280, 960, 5, UVC_VS_FORMAT_UNCOMPRESSED},
        };
