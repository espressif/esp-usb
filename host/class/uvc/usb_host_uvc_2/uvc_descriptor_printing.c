...
{
    const input_terminal_camera_desc_t *desc = (const input_terminal_camera_desc_t *) _desc;
    ...
    if (desc->wTerminalType == TERMINAL_INPUT_COMPOSITE_TYPE) {
        ...
        const input_terminal_media_desc_t *desc = (const input_terminal_media_desc_t *) _desc;
        printf("\tbControlSize %u\n", desc->bControlSize);
        printf("\tbmControls 0x%x\n", desc->bmControls);
...
{
    const output_terminal_desc_t *desc = (const output_terminal_desc_t *) _desc;
...
{
    const selector_unit_desc_t *desc = (const selector_unit_desc_t *) _desc;
...
{
    const processing_unit_desc_t *desc = (const processing_unit_desc_t *) _desc;
...
{
    const still_image_frame_desc_t *desc = (const still_image_frame_desc_t *) _desc;
...
{
    const color_format_desc_t *desc = (const color_format_desc_t *) _desc;
