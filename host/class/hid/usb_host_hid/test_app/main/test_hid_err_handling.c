...
static void test_hid_host_event_callback_open_suspended(hid_host_device_handle_t hid_device_handle,
                                                        const hid_host_driver_event_t event,
                                                        void *arg)
{
    if (event == HID_HOST_DRIVER_EVENT_CONNECTED) {
...
static void test_open_suspended_device(void)
{
    ...
    test_hid_setup(test_hid_host_event_callback_open_suspended, HID_TEST_EVENT_HANDLE_IN_DRIVER);
