 ...
 *
 * It can be defined, how the is submitted, we can successfully submit a transfer, or we can induce some transfer errors
 */
typedef enum {
...
/**
 * @brief Host test fixture, for installing CDC-ACM host driver
 *
...
/**
 * @brief Host test fixture, for uninstalling CDC-ACM host driver
 *
...
/**
 * @brief Host test fixture, for opening CDC-ACM device
 *
 ...
 */
esp_err_t mock_cdc_acm_host_open(uint8_t device_addr, uint16_t vid, uint16_t pid, uint8_t interface_idx, const cdc_acm_host_device_config_t *dev_config, cdc_acm_dev_hdl_t *cdc_hdl_ret);

/**
 * @brief Host test fixture, for closing CDC-ACM device
 *
...
/**
 * @brief Send transfer to mocked device
 *
