...
#if defined(SOC_CAPS_LIGHT_SLEEP_SUPPORTED) && defined(SOC_CAPS_DEEP_SLEEP_SUPPORTED)
...
TEST_CASE("light_sleep_dconn_no_dev", "[light_sleep][host_suspend_dconn_no_dev]")
{
    ...
    // Expect just device disconnect, no suspend, no resume events
    wait_for_app_event(&dev_gone_event, pdMS_TO_TICKS(5000));
...
#endif // SOC_CAPS_LIGHT_SLEEP_SUPPORTED && SOC_CAPS_DEEP_SLEEP_SUPPORTED
