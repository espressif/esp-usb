...
esp_err_t tinyusb_driver_install(const tinyusb_config_t *config)
{
    ...
    ESP_RETURN_ON_ERROR(tinyusb_descriptors_check(config->port, &config->descriptor), TAG, "TinyUSB descriptors check failed");
