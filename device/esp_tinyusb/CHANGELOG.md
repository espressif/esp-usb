...
- esp_tinyusb: Integrated TinyUSB as a git submodule (TinyUSB [v0.21.0~1](https://github.com/espressif/tinyusb/tree/v0.21.0.1))
- esp_tinyusb: Added ESP-IDF Build System v2 support

### Breaking changes

- esp_tinyusb: Each release now ships a fixed TinyUSB version from the component submodule. Selecting a TinyUSB version independently is no longer supported. For more details, refer to the [migration guide v2.3](../../docs/device/migration-guides/v2.3/tinyusb.md)
- esp_tinyusb: Raised the minimum ESP-IDF version from 5.0 to 5.3
