...
For automatic light sleep through PM locks on any supported target, enable **Power management**
(`CONFIG_TINYUSB_PM`) and install TinyUSB with the PM lock enabled:
