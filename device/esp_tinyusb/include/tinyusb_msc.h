 ...
 */
esp_err_t tinyusb_msc_storage_new_spiflash(const tinyusb_msc_storage_config_t *config, tinyusb_msc_storage_handle_t *handle);
 ...
 *    - ESP_ERR_NO_MEM: Not enough memory to initialize storage
 */
esp_err_t tinyusb_msc_storage_new_mmc(const tinyusb_msc_storage_config_t *config, tinyusb_msc_storage_handle_t *handle);
#endif // SOC_SDMMC_HOST_SUPPORTED
 ...
 *
 * @param[in] handle Not used, could be NULL.
 *
 * @return
