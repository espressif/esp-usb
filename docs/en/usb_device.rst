...
.. only:: not esp32p4 and not esp32s31
    ...
    On targets with full-speed port, the USB device peripheral can **NOT** be used as a light sleep wake-up source due to USB PHY limitations. This feature is only supported on hight-speed ports.
...
.. only:: esp32p4 or esp32s31
    ...
    .. only:: esp32p4
        ...
        {IDF_TARGET_NAME} having two ports, this his feature is available only on the high-speed port and **NOT** available on the full-speed port
