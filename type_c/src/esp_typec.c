...
// ---- Library state (simple singleton for now) ----
                                        ...
                                        esp_typec_port_handle_t *port_hdl_ret)
{
    ...
    ESP_RETURN_ON_FALSE(s_lib_installed, ESP_ERR_INVALID_STATE, TAG, "library not installed");
    ...
    // Apply initial role
    husb320_role_t role = HUSB320_ROLE_SINK;
    switch (port_cfg->default_power_role) {
    case ESP_TYPEC_PWR_SOURCE: role = HUSB320_ROLE_SOURCE; break;
    case ESP_TYPEC_PWR_DRP:    role = HUSB320_ROLE_DRP;    break;
    default: break;
    }
...
esp_err_t esp_typec_set_power_role(esp_typec_port_handle_t port_hdl, esp_typec_power_role_t role)
{
    ...
    husb320_role_t r = HUSB320_ROLE_SINK;
    switch (role) {
    case ESP_TYPEC_PWR_SOURCE: r = HUSB320_ROLE_SOURCE; break;
    case ESP_TYPEC_PWR_DRP:    r = HUSB320_ROLE_DRP;    break;
    default: break;
    }
    return husb320_set_role(ctx->ctrl, r);
}
